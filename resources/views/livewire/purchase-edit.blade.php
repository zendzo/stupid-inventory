    ...
    <div class="card-body">
        {{-- <form wire:submit.prevent="addSales"> --}}
            ...
            <div class="form-footer pt-5 border-top">
                <button wire:click="updatePurchase" class="btn btn-primary btn-default">
                    <div wire:loading.class="sk-wave" wire:target="updatePurchase">
                        <div class="rect1"></div>
                        <div class="rect2"></div>
                        <div class="rect3"></div>
                        <div class="rect4"></div>
                    ...
                    <div wire:loading.remove wire:target="updatePurchase">
                        Save
                    </div>
                </button>
            </div>
