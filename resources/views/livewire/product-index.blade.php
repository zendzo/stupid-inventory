                    ...
                    <table class="table table-hover ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button wire:click="getProduct({{$product->id}})" class="btn btn-sm btn-info text-white">Edit</button>
                                    <button wire:click="destroy({{$product->id}})" class="btn btn-sm btn-danger text-white">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
